...
Obviously, you can guess which option they picked. This is inconvenient for us, though, since we lose a lot of high-level debug information from the bytecode, and we lose the ability to easily patch the bytecode, and are forced instead to patch the resulting compiled assembly more directly.
